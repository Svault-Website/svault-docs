...
import { checkPortRecursive, checkNodeVersion, promptForYarn, checkForMintJson, } from './helpers.js';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    port = _a.sent();
                    shell.cd(HOME_DIR);
                    return [4 /*yield*/, checkNodeVersion()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, promptForYarn()];
                case 3:
                    _a.sent();
                    if (!(port != undefined)) return [3 /*break*/, 5];
